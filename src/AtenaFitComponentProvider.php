...
final class AtenaFitComponentProvider implements ThemePageBuilderComponentProvider
{
    ...
    public function components(): iterable
    {
        ...
        yield new PageBuilderComponentDefinition('atena_app', null, 'Aplikacja mobilna', 'Korzyści oraz ekrany aplikacji.', 'P', template: '@ShoproThemeAtenaFit/block/app.html.twig', htmlFields: ['content']);
