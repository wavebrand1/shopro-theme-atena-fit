window.ShoproThemeComponents = {
    ...
    atena_pricing: {
        ...
        defaults: {anchor: 'cennik', heading: 'Cennik', intro: 'Prosto i transparentnie. Bez ukrytych kosztów.', allPlansLabel: 'Zobacz wszystkie opcje', allPlansUrl: '#kontakt', buttonLabel: 'Kup teraz', benefit1: 'Bez umów i zobowiązań', benefit2: 'Zamrażanie karnetu', benefit3: 'Przenieś karnet na inną osobę', benefit4: 'Dostęp 24/7', items: [{name: 'Wejście jednorazowe', price: '25 zł', description: 'Jednorazowe wejście na siłownię', url: '#kontakt', buttonLabel: 'Kup teraz', icon: 'ticket', showButton: true}, {name: 'Karnet 1 miesiąc', price: '99 zł / m-c', description: 'Nielimitowany dostęp przez 30 dni', url: '#kontakt', buttonLabel: 'Kup teraz', badge: 'Najpopularniejszy', icon: 'calendar', showButton: true}, {name: 'Karnet 3 miesiące', price: '89 zł / m-c', description: 'Nielimitowany dostęp przez 90 dni', url: '#kontakt', buttonLabel: 'Kup teraz', icon: 'calendar', showButton: true}, {name: 'Karnet 12 miesięcy', price: '69 zł / m-c', description: 'Nielimitowany dostęp przez 12 miesięcy', url: '#kontakt', buttonLabel: 'Kup teraz', icon: 'calendar', showButton: true}]}
    },
    atena_steps: {
        label: 'Jak zacząć',
        itemLabel: 'krok',
    ...
    atena_cta: {label: 'CTA Atena Fit', itemLabel: 'CTA', fields: [{label: 'Kotwica sekcji', key: 'anchor', type: 'text'}, {label: 'Nagłówek', key: 'heading', type: 'text'}, {label: 'Opis', key: 'description', type: 'textarea'}, {label: 'Grafika po prawej', key: 'image', type: 'media'}, {label: 'Logo / znak wodny po lewej', key: 'watermark', type: 'media'}, {label: 'Tekst przycisku', key: 'buttonLabel', type: 'text'}, {label: 'Adres przycisku', key: 'url', type: 'text'}], defaults: {anchor: 'kontakt', heading: 'Gotowy na zmianę?', description: 'Dołącz do Atena Fit i zacznij trenować już dziś.', buttonLabel: 'Zacznij teraz', url: '#kontakt'}}
};
