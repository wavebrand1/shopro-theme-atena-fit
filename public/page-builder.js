window.ShoproThemeComponents = {
    ...
    atena_cta: {label: 'CTA Atena Fit', itemLabel: 'CTA', fields: [{label: 'Kotwica sekcji', key: 'anchor', type: 'text'}, {label: 'Nagłówek', key: 'heading', type: 'text'}, {label: 'Opis', key: 'description', type: 'textarea'}, {label: 'Grafika po prawej', key: 'image', type: 'media'}, {label: 'Znak wodny po lewej', key: 'watermarkImage', type: 'media'}, {label: 'Tekst przycisku', key: 'buttonLabel', type: 'text'}, {label: 'Adres przycisku', key: 'url', type: 'text'}], defaults: {anchor: 'kontakt', heading: 'Gotowy na zmianę?', description: 'Dołącz do Atena Fit i zacznij trenować już dziś.', buttonLabel: 'Zacznij teraz', url: '#kontakt'}}
};
