window.ShoproThemeComponents = {
    atena_hero: {
        ...
        fields: [
            {label: 'Nadtytuł', key: 'eyebrow', type: 'text'}, {label: 'Nagłówek', key: 'heading', type: 'text'},
            {label: 'Wyróżniony tekst', key: 'accent', type: 'text'}, {label: 'Treść', key: 'content', type: 'richtext'},
        ...
        defaults: {eyebrow: 'Atena Fit', heading: 'Twoja przestrzeń.', accent: 'Twój trening. Twój cel.', content: '<p>Trenuj po swojemu.</p>', primaryLabel: 'Zobacz ofertę', primaryUrl: '#cennik', secondaryLabel: 'Zobacz siłownię', secondaryUrl: '#klub'}
    },
