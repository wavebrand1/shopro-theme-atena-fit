window.ShoproThemeComponents = {
    atena_hero: {
        ...
        defaults: {eyebrow: 'Atena Fit', headingLineOne: 'Twoja', headingLineTwo: 'przestrzeń.', accent: 'Twój trening.', blueAccent: 'Twój cel.', content: '<p>Korzystaj sam<br>lub z przyjaciółmi.</p><p><strong>Skup się na treningu.</strong></p>', primaryLabel: 'Zobacz ofertę', primaryUrl: '#cennik', secondaryLabel: 'Zobacz siłownię', secondaryUrl: '#klub', items: [{icon: '▣', title: 'Nowoczesny sprzęt'}, {icon: '◷', title: 'Dostęp 24/7'}, {icon: '◉', title: 'Trenuj sam lub z innymi'}, {icon: '◎', title: 'Skup się na celu'}]}
    },
